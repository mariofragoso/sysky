        ...
        <table>
            <tr>
                <td>
                    ...
                    proporcionados
                    por la empresa Skytex Mexico, S.A. de C.V.,
                    descritos en la parte de arriba en buenas condiciones de funcionamiento, el(los) cual(es) se
                    compromete a
                    cuidarlos y utilizarlos correctamente de acuerdo a las
                    actividades que se le han asignado. De la misma manera, la(s) persona(s) que firman este documento
                    se hacen
                    responsables de cualquier daño o pérdida del
                    equipo entregado. En caso de daño o pérdida el departamento de Infraestructura de TI generará el
                    debido
                    reporte de incidencia que se entrega a Recursos
                    Humanos para tomar las medidas o sanciones que apliquen al caso. Es importante precisar que el
                    equipo de
                    cómputo es de uso personal (a menos que se indique
                    lo contrario en este formato) por lo cual la persona que firma esta hoja debe asegurarse del uso
                    adecuado
                    del mismo, no prestarlo sin supervisión, al levantarse del
                    equipo debe bloquearse y mucho menos prestar las credenciales de acceso (usuario y contraseña).
                    Cualquier
                    actividad que comprometa la integridad del equipo,
                    información y/o seguridad informática de la red de la empresa y será reportada a la Dirección de la
                    empresa
                    y departamento de Recursos Humanos quienes
